...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#333E48] text-white pb-12">
      <div
        className="w-full aspect-[1440/100] bg-no-repeat bg-bottom bg-cover mb-20"
        style={{ backgroundImage: "url('./background/bottom-cloud.svg')" }}
